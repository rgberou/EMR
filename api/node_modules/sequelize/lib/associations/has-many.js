...
module.exports = (function() {
  var HasMany = function(source, target, options) {
    ...
    /*
     * Determine associationAccessor, especially for include options to identify the correct models
     */
     ...
     */
      ...
      _.each(this.target.associations, function (association, accessor) {
        if (self.source === association.target) {
          ...
          // If through is not default, determine pairing by through value (models/string)
    ...
    /*
     * If we are double linked, and through is either default or a string, we create the through models and set it on both associations
     */
  ...
  HasMany.prototype.injectAttributes = function() {
    ...
    // or is the association on the models itself?
    if ((this.isSelfAssociation && this.through) || doubleLinked) {
      ...
      // define a new models, which connects the models
  ...
  HasMany.prototype.injectCreator = function(obj) {
    ...
    obj[this.accessors.create] = function(values, fieldsOrOptions) {
      ...
      return new Utils.CustomEventEmitter(function(emitter) {
        // Create the related models instance
        self.target
