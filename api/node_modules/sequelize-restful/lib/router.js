...
var handleResourceShow = function(modelName, identifier, callback) {
  ...
  switch(modelName) {
    case 'patients': whereClause = {SysPK_Patient : identifier}; break
    case 'doctors': whereClause = {SysPK_Doctor : identifier}; break
    case 'encounters': whereClause = {SysPK_Encounter : identifier}; break
    case 'onlineusers': whereClause = {SysPK_OLUser : identifier}; break
    case 'users': whereClause = {SysPK_User : identifier}; break
    case 'hospitalizations': whereClause = {SysPK_Hospitalization : identifier}; break
    case 'clinics': whereClause = {SysPK_Clinic : identifier}; break
    case 'clinicrooms': whereClause = {SysPK_CRoom : identifier}; break
    case 'employees': whereClause = {SysPK_Empl : identifier}; break
    default: break
  }

  if (!!daoFactory) {
    daoFactory
      .find({ where: whereClause }) ////change id to primary key fieldname  { where: { id: identifier }}
      .then(function(entry) {
        if (!entry){
...
var handleResourceUpdate = function(modelName, identifier, attributes, callback) {
  ...
  if (!!daoFactory) {
    daoFactory
      .find({ where: whereClause }) ////change id to primary key fieldname { id: identifier }
      .then(function(entry) {
        if (!entry){
...
var handleResourceDeleteAssociation = function(modelName,identifier,associatedModelName,associatedIdentifier,callback){
  ...
  if (!!associatedDaoFactory) {
    daoFactory
      .find({ where: { id: identifier }}) ////change id to primary key fieldname
